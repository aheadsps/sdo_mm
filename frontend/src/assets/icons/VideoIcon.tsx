...
const VideoIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref: Ref<SVGSVGElement>) => (
    ...
    >
      <path
        d="M1 2.93462V16.0621C1.00115 16.3311 1.09022 16.5945 1.25716 16.8225C1.42409 17.0505 1.66225 17.2341 1.94476 17.3525C2.22726 17.471 2.54287 
